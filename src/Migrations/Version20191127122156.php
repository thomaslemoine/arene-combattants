 ...
 */
final class Version20191127122156 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fighter (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, strength INT NOT NULL, intelligence INT NOT NULL, pv INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, killed_at DATETIME DEFAULT NULL, slug LONGTEXT NOT NULL, king TINYINT(1) DEFAULT NULL, INDEX IDX_7A08C3FCC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE battle (id INT AUTO_INCREMENT NOT NULL, zone_id INT DEFAULT NULL, winner_id INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_139917349F2C3FAB (zone_id), INDEX IDX_139917345DFCD4B8 (winner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE battle ADD CONSTRAINT FK_139917345DFCD4B8 FOREIGN KEY (winner_id) REFERENCES fighter (id)');
